                ...
                <div className="w-[250px] h-full  bg-[#4C7F31] text-black py-[12px] rounded-[10px] shadow-xl">
                    <div className="w-[226px] h-full bg-white mx-auto rounded-[25px] rounded-tr-[80px] rounded-bl-[80px] px-[20px]">
                        ...
                        <div className="mt-6 flex items bg-main/10 px-2 py-2 rounded-[10px]">
                            ...
                            <div className="w-[70%]">
                                <h2 className='font-nomal text-[14px] text-black/20 font-["roboto"]'>
                                    Admin
                                </h2>
                        ...
                        <div className='font-["roboto"] w-full text-center mt-10 flex flex-col gap-3'>
                            <Link
                                to="/dashboard/qluser"
                                className="transition-all duration-300 w-full hover:bg-main/15 text-black/50 hover:text-[#4C7F31] py-2 rounded-[10px]"
                            >
                                <div className="">Quản lý người dùng</div>
                            </Link>
                            ...
                            <Link
                                ...
                                className="transition-all duration-300 w-full hover:bg-main/15 text-black/50 hover:text-[#4C7F31] py-2 rounded-[10px]"
                            >
                                <div className="">Quản lý danh mục</div>
                            </Link>
                            ...
                            <Link
                                ...
                                className="transition-all duratiduratisn-300 w-full hover:bg-main/15 text-black/50 hover:text-[#4C7F31] py-2 rounded-[10px]"
                            >
