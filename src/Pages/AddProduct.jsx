...
// Sửa import path - kiểm tra đường dẫn thực tế của authService
// import { getCurrentUserId } from "./Services/authService"; // Nếu trong cùng thư mục
// Hoặc: import { getCurrentUserId } from "../Services/authService";
// Hoặc: import { getCurrentUserId } from "../../Services/authService";
...
const AddProductFixed = () => {
    ...
    // Sử dụng giao diện đẹp hơn với Tailwind
    return (
                ...
                {userId && (
                    <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                        <p className="text-sm text-green-700">
                            👤 Đang đăng nhập với ID: <strong>{userId}</strong>
                        </p>
                    </div>
                )}
                ...
                {categories.length > 0 && (
                    <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <p className="text-sm text-blue-700 mb-2">
                            📋 Có <strong>{categories.length}</strong> loại thực
                            phẩm
                        </p>
