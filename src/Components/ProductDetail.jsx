...
export const ProductDetail = ({ product, onClose }) => {
    ...
    const handleReceiveAction = async () => {
        ...
        console.log("🚀 Gửi yêu cầu nhận:", { productId: product.id, userid: currentUserId });
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-hidden animate-fadeIn">
                ...
                <div className="relative h-48">
                    <img src={detail.images?.[0]?.image || product.img} alt={product.name} className="w-full h-full object-cover" />
                    ...
                    <div className="flex items-center justify-between mb-6 bg-gray-50 rounded-xl p-4">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-800">{detail.location}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-2">
                            <Package className="w-5 h-5 text-gray-400" />
                            <div>
                                <p className="text-xs text-gray-500 uppercase tracking-wider">Loại</p>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 mb-5 border border-gray-100">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center">
                                <span className="w-28 text-sm text-gray-500">Người đăng:</span>
                                <span className="font-semibold text-gray-800">{detail.user?.userName || "Người chia sẻ"}</span>
                            </div>
                            <div className="flex items-center">
                                <span className="w-28 text-sm text-gray-500">Số điện thoại:</span>
                    ...
                    <div className="flex gap-3 pt-6 border-t border-gray-100">
                        ...
                        <button
                            ...
                            className={`px-6 py-3 text-white font-bold rounded-xl shadow-md flex-1 flex items-center justify-center transition-all
                                ${(isPending || isLoadingAction) ? "cursor-not-allowed grayscale" : "hover:shadow-lg active:scale-95"}`}
                            style={{ 
