...
export const Card_Product = () => {
  ...
  return (
    <div className='w-full grid grid-cols-3 gap-8'>
      {
        data_product.map(u => (
          <div className='group transition-all h-[395px] relative bg-white overflow-hidden font-["roboto"] rounded-[5px] mt-6'>
            <div className='relative h-[200px] overflow-hidden w-[100%] mx-auto'>
              <img key={u.id} className='group-hover:scale-110 transition-all box-border duration-500 w-full h-full object-cover cursor-pointer' src={u.img} alt="" />
            ...
            <div className='absolute bottom-0 w-full flex justify-between border-t'>
              ...
              <button className='w-[100%] relative z-[1] h-full py-2 before:bg-main
