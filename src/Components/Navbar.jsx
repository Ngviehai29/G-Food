...
export const Navbar = ({ settologin }) => {
    ...
    return (
        <div
            className={`fixed z-[99] w-[100%] transition-all duration-500 shadow-[0_6px_20px_rgba(0,0,0,0.15)] ${scrolled ? "h-[70px] bg-[#ffffffec]" : "h-[85px] bg-[#ffffff00]"
                }`}
        >
                ...
                <div className="search-container justify-end flex gap-6 items-center w-[30%]">
                    ...
                    <div className="right flex justify-end gap-6 items-center">
                        ...
                        {user ? (
                            ...
                            <>
                                <div className={` flex gap-2 font-[roboto] text-[14px] transition-all duration-300 ${searchOpen ? "opacity-0 text-[0px]" : ""}`}>
